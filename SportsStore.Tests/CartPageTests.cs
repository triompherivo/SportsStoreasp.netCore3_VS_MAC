...
namespace SportsStore.Tests
{
    ...
    public class CartPageTests
    {
        ...
        public void Can_Load_Cart()
        {
            ...
            Mock<ISession> mockSession = new Mock<ISession>(); byte[] data =
        ...
        public void Can_Update_Cart()
        {
            ...
            Mock<IStoreRepository> mockRepo = new Mock<IStoreRepository>(); 
            mockRepo.Setup(m => m.Products).Returns((new Product[] {
                new Product { ProductID = 1, Name = "P1" } }).AsQueryable<Product>());
            Cart testCart = new Cart();
            Mock<ISession> mockSession = new Mock<ISession>(); mockSession.Setup(s => s.Set(It.IsAny<string>(), It.IsAny<byte[]>()))
