...
namespace SportsStore.Tests
{
    public class ProductControllerTests
    {
        ...
        {
            // Arrange
            Mock<IStoreRepository> mock = new Mock<IStoreRepository>(); mock.Setup(m => m.Products).Returns((new Product[] {
        ...
        public void Can_Paginate()
        {
            ...
            HomeController controller = new HomeController(mock.Object); controller.PageSize = 3;
